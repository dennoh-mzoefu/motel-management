...
function Sidebar({ activeMenu, setActiveMenu, screenSize, setScreenSize }) {
  ...
  // }, [user, users]);
  return (
    <div className="fixed top-0 left-0 h-full z-10 bg-slate-500 ">
      {/* {console.log({ role })} */}
      {activeMenu && (
        <div className="bg-stone-900  shadow-xl h-screen border-r border-slate-300/90 flex flex-col w-fit ">
          <div className="flex w-fit ml-4 mt-8 justify-center items-center">
            <img
              src={logo}
              className="h-10 shadow-md drop-shadow-lg shadow-slate-200 rounded-full w-fit mt-5  "
            />
            <h1 className="ml-4 text-2xl text-white drop-shadow-lg font-bold">
              Great
              <br /> Pastures
            </h1>
          </div>
          <div className="my-5 justify-end border-b border-white" />
